    ...
    $.fn.scrollTo = function(l, j, a) {
        ...
        return this.scrollable().each(function() {
            ...
            $.each(a.axis.split(''), function(b, h) {
                var f = h == 'x' ? 'Left': 'Top', i = f.toLowerCase(), c = 'scroll' + f, r = k[c], s = h == 'x' ? 'Width': 'Height';
                if (p) {
...
/* jQuery.LocalScroll - Animated scrolling navigation, using anchors - Copyright (c) 2007-2009 Ariel Flesler - aflesler(at)gmail(dot)com | http://flesler.blogspot.com - Dual licensed under MIT and GPL - Date: 3/11/2009 - @author Ariel Flesler - @version 1.2.7 */
;
(function($) {
