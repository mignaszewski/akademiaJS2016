    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function styleMenu(section, index){
            ...
            //moving the menu outside the main.js container if it is inside (avoid problems with fixed positions when using CSS3 tranforms)
        ...
        */
        ...
        /**
         * Activating the website main.js menu elements according to the given slide name.
         */
